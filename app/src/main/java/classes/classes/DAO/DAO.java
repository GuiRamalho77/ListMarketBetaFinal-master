...
public class DAO implements Serializable {
    ...
    private static final String INSERIRLISTAS = "inserirListas";
    ...
    public boolean inserirProduto(produtos produtos) {
        ...
        SoapObject inserirListasCompras = new SoapObject(NAMESPACE, INSERIRPPRODUTO);
        SoapObject user = new SoapObject(NAMESPACE, "produtos");
        user.addProperty("idproduto", produtos.getIdproduto());
        user.addProperty("nomeproduto", produtos.getNomeproduto());
        user.addProperty("quantidade", produtos.getQuantidade());
        user.addProperty("valor", produtos.getValor());
        user.addProperty("idlista", produtos.listascompras.getIdlista());
        ...
        try {
            http.call("urn:" + INSERIRPPRODUTO, envelope);
            SoapPrimitive response = (SoapPrimitive) envelope.getResponse();
            return Boolean.parseBoolean(response.toString());
